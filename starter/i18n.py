...
from starter.resources import app_locale as app_locale_key
...
class LanguageCode(str, Enum):
    ...
    @classmethod
    def get_all(cls) -> set[LanguageCode]:
        return {cls.EN, cls.JA}


# Locale for prompts and app front end
APP_LOCALE: LanguageCode = LanguageCode.EN

app_locale_env_name: str = app_locale_key
...
class LocaleSettings(BaseSettings):
    ...
    def setup_locale(self) -> None:
        ...
        if application_locale not in LanguageCode.get_all():
